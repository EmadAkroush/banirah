        ...
        <div class="p-4">
          ...
          >
            <DataTable :value="product" class="p-datatable-gridlines">
              ...
              <Column field="app_pro_title" header="نوع مرخصی" sortable></Column>
              <Column field="appdelcr_app_tas_title" header="واحد مربوطه" sortable></Column>
              <Column field="mabdae" header="مبداء" sortable></Column>
              <Column field="maghsad" header="مقصد" sortable></Column>
              <Column field="del_delegate_date" header="تاریخ رفت" sortable></Column>
              <Column
...
export default {
      ...
      tableData: [
        {
          ...
          mabdae: "مشهد",
          maghsad: "رامسر",
          tarikhraft: "۳۰ اردیبهشت ۱۴۰۳",
          tarikhbargasht: "۳۰ اردیبهشت ۱۴۰۳",
        },
        {
          index: 1,
          noemorakhasi: "روزانه",
  ...
  methods: {
    async getproduct() {
      try {
        this.product = await $fetch("/api/general/mission");
      } catch (error) {
        console.log(error);
      } finally {
