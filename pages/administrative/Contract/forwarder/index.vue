    ...
    <div class="main p-6">
      <div class="flex sec1">
        <div class="flex align-center">
          ...
          <div class="mr-2 text-right">
            <p class="text-right">قرارداد فورواردری  </p>
          </div>
        </div>
        <div
      ...
      <div>
        <div class="p-8 bg-white rounded-lg mx-auto mt-8">
          <h2 class="text-xl font-semibold mb-4">قرارداد  فورواردری</h2>
          <form class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              <label for="email" class="block text-gray-700"> نام و نام حانوادگی مدیریت </label>
              <InputText
                id="email"
                v-model="form.email"
                class="mt-1 block w-full"
            ...
            <div class="flex flex-col text-right">
              <label for="product-type" class="mb-1 text-gray-700">نوع فراورده </label>
              <Dropdown
                id="product-type"
            ...
            <div class="flex flex-col text-right">
              <label for="product-type" class="mb-1 text-gray-700"> مبداء </label>
              <Dropdown
                id="product-type"
                :options="dropdownOptions"
                optionLabel="label"
            ...
            <div class="flex flex-col text-right">
              <label for="product-type" class="mb-1 text-gray-700"> گمرک مبداء </label>
              <Dropdown
                id="product-type"
                :options="dropdownOptions"
                optionLabel="label"
            ...
            <div class="flex flex-col text-right">
              <label for="product-type" class="mb-1 text-gray-700"> گمرک مقصد </label>
              <Dropdown
                id="product-type"
                :options="dropdownOptions"
                optionLabel="label"
            ...
            <div class="flex flex-col text-right">
              <label for="product-type" class="mb-1 text-gray-700">به مدت</label>
              <Dropdown
                id="product-type"
                :options="dropdownOptions"
                optionLabel="label"
            ...
            <div class="flex flex-col text-right">
              ...
              >
                <template #empty>
                  <span>  کشیدن و رها کردن فایل </span>
                </template>
              </FileUpload>
            </div>
            <div class="flex flex-col  text-right">
            ...
            <div class="flex flex-col  text-right">
              <div class="flex items-center gap-2">
                ...
                <label for="ingredient1">
                  قوانین و شرایط قرارداد را خوانده و می پذیرم
                </label>
              </div>
            </div>
      ...
      <div class="flex mt-4">
        <Button
          label="مشاهده قوانین"
          class="p-button-text text-green-700 border-green-700"
          style="background-color: #cedccd; color: #0c4e07"
        />
        <Button
          label="مشاهده قرارداد"
          class="p-button-text text-green-700 border-green-700 mr-4"
          style="background-color: #cedccd; color: #0c4e07"
        />
      </div>
    </div>
